...
def run(bench_name: str) -> None:
    ...
    save_app_selection(bench_name, selection)
    ...
    print(f"  SELECTED_INDUSTRY={config.get('SELECTED_INDUSTRY', '')}")
    print(f"  SELECTED_BUSINESS_MODULES={config.get('SELECTED_BUSINESS_MODULES', '')}")
